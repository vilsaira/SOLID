...
4.0) Use SOLID weights in the model estimation. This depends highly on the software you are using. For example, MDT v0.14.5 and later has the required functionality to add user defined weights [4]:

  > input_data = mdt.load_input_data(...
                                     volume_weights=weights
                                     )

Steps from 1 to 4 are currently being included also in ExploreDTI and should be released shortly [5].
